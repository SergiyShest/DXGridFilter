...
describe("GetFilterGetFilterBetween Tests", function () {

    it("test  ", function () {
        var exp = "";
        var resFilter = FilterHelper.GetFilterBetween(exp, 'date', 'date', '2000-12-12', '2000-10-10').trim();
        console.log(resFilter);
        expect(resFilter).to.equal('[date] >= #2000 - 12 - 12# and [date] <= #2000 - 10 - 10#');
    });
