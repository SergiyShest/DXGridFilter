...
var FilterHelper = function () {
    _createClass(FilterHelper, null, [{
        key: 'RemoveFromExpession',
        value: function RemoveFromExpession(expression, condField) {
    ...
    _createClass(FilterHelper, null, [{
        key: 'Normalaze',
        value: function Normalaze(expression) {
        ...
        */
        ...
        key: 'ApplyInCon',
        value: function ApplyInCon(filterStr, condField, condValues, dataType) {
        ...
        */
        ...
        key: 'GetFilterInFromText',
        value: function GetFilterInFromText(fieldName, filterText, filterStr) {
        ...
        key: 'GetFilterContainsFromText',
        value: function GetFilterContainsFromText(filterStr, fieldName, searchedValue, compareType) {
        ...
        key: 'GetFilterBetween',
        value: function GetFilterBetween(filterStr, fieldName, dataType, searchedValueFrom, searchedValueTo) {
